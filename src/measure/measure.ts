...
// 1. Create a new class called Measure that extends TwoPointDrawing
export class Measure extends TwoPointDrawing {
  ...
  protected _mouseIsOverDrawing(param: MouseEventParams, tolerance = 4) {
    ...
    return (
      mouseX > mainX - halfTolerance &&
      mouseX < mainX + width + halfTolerance &&
      mouseY > mainY - halfTolerance &&
      mouseY < mainY + height + halfTolerance
    );
  }
}
